...
# 要約
　大学院情報科学研究科を卒業後、自社機器の制御・ステータス管理を行うWindowsアプリを開発する部署に所属している。使用言語はC#.NET。よりよくなると考えたことは提案している。その提案のうち一つが実際に導入された。業務外では、積極的な情報発信を行っている。
...
## ケーブルテレビへの4K放送追加
2018年7月 ～ 2018年11月  
ケーブルテレビに4K放送が追加されるにあたり、実装された機能の検証と手順書作成を行った。  
- 全体図を見ながら実際にシステムを構築
